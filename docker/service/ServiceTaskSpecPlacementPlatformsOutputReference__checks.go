...
func (s *jsiiProxy_ServiceTaskSpecPlacementPlatformsOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (s *jsiiProxy_ServiceTaskSpecPlacementPlatformsOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_ServiceTaskSpecPlacementPlatformsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *ServiceTaskSpecPlacementPlatforms, cdktf.IResolvable; received %#v (a %T)", val, val)
		}
	}
